...
%%
i = floor(0.2*length(out1));
window = out1(i:i+1024*16);
plot((1:length(window))/sampRate, abs(fft(window)))
plot(abs(fft(window)))
%plot((1:length(reOut1))/sampRate,imOut1)
